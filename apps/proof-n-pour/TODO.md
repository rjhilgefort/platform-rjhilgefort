# Proof & Pour - Setup TODO

Complete checklist for launching your Proof & Pour site.
...
- **Configuration**: 0/4 complete
- **Priority 1 (Hero Banners)**: 0/6 complete
- **Priority 2 (Branding)**: 0/2 complete (placeholders active)
- **Priority 3 (Bottles)**: 0/4 complete
- **Priority 4 (Cocktails)**: 0/4 complete
- **Priority 5 (Events)**: 0/3 complete

**Total**: 0/23 items complete
