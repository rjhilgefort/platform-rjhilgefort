...
const About = () => {
  return (
    <div className="flex flex-col xl:flex-row justify-center items-center xl:gap-20 gap-6 mt-10 md:mt-20 mb-20 md:mb-32">
      ...
      <div className="max-w-lg">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-black brightness-150">
          I am Antonio, a digital marketer and the founder of a marketing
          agency.
        </h1>
        <div className="space-y-7 mt-6">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio
            necessitatibus deserunt suscipit ad voluptas beatae ratione. At
            dicta, repudiandae, mollitia placeat fuga nihil doloribus vel
            voluptas error quae consequuntur repellendus.
          </p>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio
            necessitatibus deserunt suscipit ad voluptas beatae ratione. At
      ...
      <div className="mt-6 xl:mt-0 flex xl:flex-col gap-4">
        <a
